        ...
        <div className="min-h-screen bg-gradient-to-b from-meme-blue via-floor-pink to-moon-yellow p-4 font-comic">
            ...
            <header className="max-w-6xl mx-auto pt-8 text-center">
                ...
                <div className="bg-white rounded-lg p-8 mb-8 transform -rotate-1 border-4 border-floor-pink">
                    ...
                    <p className="text-xl mb-4">
                        hey fren! welcome to NAB (Number Always Bigger) - the
                        token that literally only goes up. no fancy promises,
                        just pure mathematic certainty that number go up
                        (probably).
                    </p>
                    <p className="text-xl">
                ...
                <div className="bg-white rounded-lg p-8 transform -rotate-1 border-4 border-crypto-green">
                    ...
                    <Alert className="border-4 border-moon-yellow mb-8">
                        ...
                        <AlertDescription className="text-xl space-y-4">
                            <p>1. stake fren tokens in our special contract</p>
            ...
            <section className="max-w-4xl mx-auto my-16">
                <div className="bg-white rounded-lg p-8 transform rotate-1 border-4 border-tech-purple">
                    ...
                    <p className="text-xl mb-4">
                        ...
                        that&apos;s the whole point. if you&apos;re looking for
                        complex tokenomics and multi-paragraph explanations,
                        you&apos;re in the wrong place fren. we keep it simple:
                    </p>
                    ...
                    <p className="text-xl italic">
                        (but also yes, we&apos;re actually built on super solid
                        math that makes this work. we just don&apos;t like to
                        brag about it)
                        <a href="#" className="text-meme-blue hover:underline">
                            {' '}
            ...
            <footer className="max-w-6xl mx-auto text-center py-8">
                ...
                <div className="text-lg mt-4 text-gray-800">
                    🌈 remember: number literally cannot go down. it&apos;s not
                    just a meme, it&apos;s mathematic certainty
                    <br />
